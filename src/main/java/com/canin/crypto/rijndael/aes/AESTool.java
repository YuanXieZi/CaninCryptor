package com.canin.crypto.rijndael.aes;
...
public class AESTool {
        ...
        if (workMode != null) {
            switch (workMode) {
                ...
                case CTR:
                    ...
                    break;
                case CFB:
                    blockCipher = new CFBBlockCipher(new AESEngine(), refluxBits);
                    break;
                case OFB:
                    blockCipher = new OFBBlockCipher(new AESEngine(), refluxBits);
                    break;
                default:
            }
        }
    ...
    public AESTool(boolean isEncryption, byte[] key, byte[] iv, WorkMode workMode, Paddings padding, int refluxBits) {
        init(isEncryption, key, iv, workMode, padding, refluxBits);
    }

    public AESTool(boolean isEncryption, byte[] key, byte[] iv, WorkMode workMode, Paddings padding) {
