...
public class DESTool {
    ...
    private byte[] key;//length must be 8
    ...
    public DESTool(boolean isEncryption, byte[] key, byte[] iv, WorkMode workMode, Paddings padding, int refluxBits) {
        ...
        if (workMode != null) {
            switch (workMode) {
                ...
                case CTR:
                    ...
                    break;
                case CFB:
                    blockCipher = new CFBBlockCipher(new DESEngine(), refluxBits);
                    break;
                case OFB:
                    blockCipher = new OFBBlockCipher(new DESEngine(), refluxBits);
                    break;
                default:
            }
        }
    ...
    public DESTool(boolean isEncryption, byte[] key, byte[] iv, WorkMode workMode, Paddings padding) {
